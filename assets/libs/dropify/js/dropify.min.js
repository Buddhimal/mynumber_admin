...
!function (e, i) {
	...
	return i.prototype.onChange = function () {
		...
		if (i.files && i.files[0]) {
			var t = new FileReader, s = new Image, r = i.files[0], n = null, o = this, h = e.Event("dropify.fileReady");
		...
		var i = 0;
		if (0 !== e) {
			var t = e.slice(-1).toUpperCase(), s = 1024, r = 1024 * s, n = 1024 * r;
